...
module.exports = (db) => {
  ...
  function filtersFromQuery(q) {
    return {
      ...
      personRegionExclude: q.personRegionExclude, personCountyExclude: q.personCountyExclude, personTownExclude: q.personTownExclude,
      companyCity: q.companyCity, companyState: q.companyState, companyCountry: q.companyCountry,
      companyCityExclude: q.companyCityExclude, companyStateExclude: q.companyStateExclude, companyCountryExclude: q.companyCountryExclude,
      ...
      companyRegionExclude: q.companyRegionExclude, companyCountyExclude: q.companyCountyExclude, companyTownExclude: q.companyTownExclude,
      ...
      ccodOwnsBuilding: q.ccodOwnsBuilding,
      solarStatus: q.solarStatus,
      solarMinKwp: q.solarMinKwp,
  ...
  router.get('/contacts/search', async (req, res) => {
    try {
      ...
      const filters = {
        ...
        personRegionExclude: rest.personRegionExclude, personCountyExclude: rest.personCountyExclude, personTownExclude: rest.personTownExclude,
        companyCity: rest.companyCity, companyState: rest.companyState, companyCountry: rest.companyCountry,
        companyCityExclude: rest.companyCityExclude, companyStateExclude: rest.companyStateExclude, companyCountryExclude: rest.companyCountryExclude,
        // Normalised location hierarchy filters (Country>Region>County>City>Town)
        companyRegion: rest.companyRegion, companyCounty: rest.companyCounty, companyTown: rest.companyTown,
        companyRegionExclude: rest.companyRegionExclude, companyCountyExclude: rest.companyCountyExclude, companyTownExclude: rest.companyTownExclude,
